...
-- Inserts para la tabla Planilla
INSERT INTO Planilla (Codigo_Planilla, Fecha, Monto) VALUES
('PL001', '2024-01-15', 15000.00),
('PL002', '2024-02-15', 15500.00),
('PL003', '2024-03-15', 16000.00),
('PL004', '2024-04-15', 16200.00),
('PL005', '2024-05-15', 16500.00),
('PL006', '2024-06-15', 17000.00),
('PL007', '2024-07-15', 17500.00),
('PL008', '2024-08-15', 18000.00),
('PL009', '2024-09-15', 18500.00),
('PL010', '2024-10-15', 19000.00),
('PL011', '2024-11-15', 19500.00),
('PL012', '2024-12-15', 20000.00),
('PL013', '2023-01-15', 14500.00),
('PL014', '2023-02-15', 15000.00),
('PL015', '2023-03-15', 15500.00),
('PL016', '2023-04-15', 16000.00),
('PL017', '2023-05-15', 16500.00),
('PL018', '2023-06-15', 17000.00),
('PL019', '2023-07-15', 17500.00),
('PL020', '2023-08-15', 18000.00),
('PL021', '2023-09-15', 18500.00),
('PL022', '2023-10-15', 19000.00),
('PL023', '2023-11-15', 19500.00),
('PL024', '2023-12-15', 20000.00),
('PL025', '2022-01-15', 14000.00),
('PL026', '2022-02-15', 14500.00),
('PL027', '2022-03-15', 15000.00),
('PL028', '2022-04-15', 15500.00),
('PL029', '2022-05-15', 16000.00),
('PL030', '2022-06-15', 16500.00);

select Cedula from Usuario WHERE Puesto LIKE 'Vendedor'

-- Inserts para la tabla Planilla_Usuario (200 horas obligatorias + horas extras)
INSERT INTO Planilla_Usuario (Codigo_Planilla, Cedula_Usuario, Horas_Trabajadas, Horas_Extras, Salario_Pagado, Departamento) VALUES
('PL001', '00112233441', 200, 20, 2400.00, 'Ventas'),
('PL001', '00112233442', 200, 15, 2600.00, 'Ventas'),
('PL002', '00112233443', 200, 25, 2750.00, 'Ventas'),
('PL002', '00112233444', 200, 20, 2650.00, 'Ventas'),
('PL003', '00112233445', 200, 30, 2800.00, 'Ventas'),
('PL003', '00112233446', 200, 20, 2500.00, 'Marketing'),
('PL004', '00112233447', 200, 15, 2700.00, 'Marketing'),
('PL004', '00112233448', 200, 25, 2550.00, 'Marketing'),
('PL005', '00112233449', 200, 20, 2600.00, 'Marketing'),
('PL005', '00112233450', 200, 20, 2650.00, 'Marketing'),
('PL006', '00112233451', 200, 25, 2900.00, 'Desarrollo'),
('PL006', '00112233459', 200, 20, 2850.00, 'Desarrollo'),
('PL007', '00112233453', 200, 20, 2750.00, 'Desarrollo'),
('PL007', '00112233454', 200, 25, 2800.00, 'Desarrollo'),
('PL008', '00112233455', 200, 15, 2700.00, 'Desarrollo'),
('PL008', '00112233456', 200, 20, 2600.00, 'Soporte Técnico'),
('PL009', '00112233457', 200, 30, 2850.00, 'Soporte Técnico'),
('PL009', '00112233458', 200, 25, 2750.00, 'Soporte Técnico'),
('PL010', '00112233459', 200, 20, 2650.00, 'Soporte Técnico'),
('PL010', '00112233460', 200, 15, 2550.00, 'Soporte Técnico'),
('PL011', '00112233461', 200, 25, 2850.00, 'Ventas'),
('PL011', '00112233462', 200, 20, 2750.00, 'Ventas'),
('PL012', '00112233463', 200, 20, 2700.00, 'Ventas'),
('PL012', '00112233464', 200, 30, 2800.00, 'Ventas'),
('PL013', '00112233465', 200, 20, 2850.00, 'Administración'),
('PL013', '00112233466', 200, 15, 2750.00, 'Administración'),
('PL014', '00112233467', 200, 25, 2900.00, 'Administración'),
('PL014', '00112233441', 200, 20, 2750.00, 'Ventas'),
('PL015', '00112233442', 200, 15, 2650.00, 'Ventas'),
('PL015', '00112233443', 200, 25, 2800.00, 'Ventas');
...
INSERT INTO Entrada_Inventario (Codigo_Movimiento, Usuario, Bodega_Destino, Fecha_Hora) VALUES
('M002', '00112233442', 'B002', '2024-01-02 11:00:00'),
('M003', '00112233443', 'B003', '2024-01-03 12:00:00'),
('M004', '00112233444', 'B004', '2024-01-04 13:00:00'),
('M005', '00112233445', 'B005', '2024-01-05 14:00:00'),
('M006', '00112233446', 'B006', '2024-01-06 15:00:00'),
('M007', '00112233447', 'B007', '2024-01-07 16:00:00'),
('M008', '00112233448', 'B008', '2024-01-08 17:00:00'),
('M009', '00112233449', 'B009', '2024-01-09 18:00:00'),
('M010', '00112233450', 'B010', '2024-01-10 19:00:00'),
('M011', '00112233441', 'B001', '2024-01-11 10:00:00'),
('M012', '00112233442', 'B002', '2024-01-12 11:00:00'),
('M013', '00112233443', 'B003', '2024-01-13 12:00:00'),
('M014', '00112233444', 'B004', '2024-01-14 13:00:00'),
('M015', '00112233445', 'B005', '2024-01-15 14:00:00'),
('M016', '00112233446', 'B006', '2024-01-16 15:00:00'),
('M017', '00112233447', 'B007', '2024-01-17 16:00:00'),
('M018', '00112233448', 'B008', '2024-01-18 17:00:00'),
('M019', '00112233449', 'B009', '2024-01-19 18:00:00'),
('M020', '00112233450', 'B010', '2024-01-20 19:00:00'),
('M021', '00112233441', 'B001', '2024-01-21 10:00:00'),
('M022', '00112233442', 'B002', '2024-01-22 11:00:00'),
('M023', '00112233443', 'B003', '2024-01-23 12:00:00'),
('M024', '00112233444', 'B004', '2024-01-24 13:00:00'),
('M025', '00112233445', 'B005', '2024-01-25 14:00:00'),
('M026', '00112233446', 'B006', '2024-01-26 15:00:00'),
('M027', '00112233447', 'B007', '2024-01-27 16:00:00'),
('M028', '00112233448', 'B008', '2024-01-28 17:00:00'),
('M029', '00112233449', 'B009', '2024-01-29 18:00:00'),
('M030', '00112233450', 'B010', '2024-01-30 19:00:00');

-- Detalle de artículos por entrada
INSERT INTO Entrada_Articulo (Codigo_Movimiento, Codigo_Articulo, Cantidad) VALUES
('M001', 'A001', 10), ('M001', 'A002', 5), ('M001', 'A003', 15),
('M002', 'A004', 20), ('M002', 'A005', 10),
('M003', 'A006', 30), ('M003', 'A007', 25),
('M004', 'A008', 12), ('M004', 'A009', 18),
('M005', 'A010', 20), ('M005', 'A011', 15),
('M006', 'A012', 10), ('M006', 'A013', 8),
('M007', 'A014', 5), ('M007', 'A015', 7),
('M008', 'A016', 30), ('M008', 'A017', 50),
('M009', 'A018', 20), ('M009', 'A019', 25),
('M010', 'A020', 15), ('M010', 'A021', 12),
('M011', 'A022', 40), ('M011', 'A023', 10),
('M012', 'A024', 10), ('M012', 'A025', 30),
('M013', 'A026', 25), ('M013', 'A027', 30),
('M014', 'A028', 50), ('M014', 'A029', 35),
('M015', 'A030', 20), ('M015', 'A031', 45),
('M016', 'A032', 30), ('M016', 'A033', 50),
('M017', 'A034', 25), ('M017', 'A035', 40),
('M018', 'A036', 10), ('M018', 'A037', 20),
('M019', 'A038', 15), ('M019', 'A039', 30),
('M020', 'A040', 25), ('M020', 'A041', 30),
('M021', 'A042', 10), ('M021', 'A043', 20),
('M022', 'A044', 15), ('M022', 'A045', 35),
('M023', 'A046', 40), ('M023', 'A047', 20),
('M024', 'A048', 30), ('M024', 'A049', 15),
('M025', 'A050', 25), ('M025', 'A001', 20),
('M026', 'A002', 30), ('M026', 'A003', 50),
('M027', 'A004', 40), ('M027', 'A005', 30),
('M028', 'A006', 25), ('M028', 'A007', 10),
('M029', 'A008', 50), ('M029', 'A009', 30),
('M030', 'A010', 40), ('M030', 'A011', 20);

select * from Entrada_Articulo

-- Insertar datos en Movimiento_Inventario
INSERT INTO Movimiento_Inventario (Codigo_Movimiento, Bodega_Origen, Bodega_Destino, Usuario, Fecha_Hora) VALUES
('M001', 'B001', 'B002', '00112233441', '2024-01-01 10:00:00'),
('M002', 'B003', 'B004', '00112233442', '2024-01-02 11:00:00'),
('M003', 'B002', 'B005', '00112233443', '2024-01-03 12:30:00'),
('M004', 'B001', 'B003', '00112233444', '2024-01-04 09:45:00'),
('M005', 'B005', 'B006', '00112233445', '2024-01-05 08:15:00'),
('M006', 'B007', 'B008', '00112233446', '2024-01-06 14:00:00'),
('M007', 'B006', 'B009', '00112233447', '2024-01-07 15:20:00'),
('M008', 'B004', 'B010', '00112233448', '2024-01-08 16:45:00'),
('M009', 'B003', 'B001', '00112233449', '2024-01-09 10:10:00'),
('M010', 'B002', 'B004', '00112233450', '2024-01-10 11:30:00'),
('M011', 'B006', 'B001', '00112233451', '2024-01-11 09:00:00'),
('M012', 'B005', 'B002', '00112233459', '2024-01-12 13:15:00'),
('M013', 'B004', 'B003', '00112233453', '2024-01-13 14:30:00'),
('M014', 'B007', 'B005', '00112233454', '2024-01-14 15:45:00'),
('M015', 'B009', 'B006', '00112233455', '2024-01-15 10:30:00'),
('M016', 'B008', 'B002', '00112233456', '2024-01-16 12:00:00'),
('M017', 'B001', 'B003', '00112233457', '2024-01-17 14:45:00'),
('M018', 'B010', 'B004', '00112233458', '2024-01-18 16:10:00'),
('M019', 'B003', 'B007', '00112233459', '2024-01-19 09:40:00'),
('M020', 'B002', 'B006', '00112233460', '2024-01-20 13:50:00'),
('M021', 'B005', 'B008', '00112233461', '2024-01-21 15:20:00'),
('M022', 'B006', 'B009', '00112233462', '2024-01-22 08:30:00'),
('M023', 'B004', 'B010', '00112233463', '2024-01-23 10:15:00'),
('M024', 'B003', 'B001', '00112233464', '2024-01-24 11:45:00'),
('M025', 'B002', 'B004', '00112233465', '2024-01-25 14:10:00'),
('M026', 'B006', 'B003', '00112233466', '2024-01-26 16:30:00'),
('M027', 'B005', 'B002', '00112233467', '2024-01-27 09:20:00'),
('M028', 'B004', 'B007', '00112233441', '2024-01-28 13:00:00'),
('M029', 'B009', 'B006', '00112233442', '2024-01-29 15:45:00'),
('M030', 'B008', 'B005', '00112233443', '2024-01-30 10:50:00');

-- Insertar datos en Movimiento_Articulo
INSERT INTO Movimiento_Articulo (Codigo_Movimiento, Codigo_Articulo, Cantidad) VALUES
('M001', 'A001', 10),
('M001', 'A002', 5),
('M002', 'A003', 15),
('M002', 'A004', 20),
